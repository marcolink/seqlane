...
Run: `seqlane run workflows/read-context/workflow.ts --input '{"question":"where is workflow loading implemented?"}' --runtime opencode`
...
retrieval tools and model runtime. Consumers own their hook or host adaptation;
