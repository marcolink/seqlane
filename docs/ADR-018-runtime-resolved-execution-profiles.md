# ADR-018 — Resolve Workflow Agent Profiles at Runtime

**Status:** Proposed
**Scope:** Workflow/task agent selection, runtime configuration, OpenCode adapter setup, and agent-transition warnings
**Related:** ADR-004, ADR-005, ADR-008, ADR-016
...
- ADR-008 remains intact: `agent` is a logical Seqlane runtime key, not an
