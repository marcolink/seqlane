# TS-013-01 — Extend Runner Events for Graph Topology and Values
...
path selection. A selected value must satisfy the TS-013 size and depth limits.
...
- [TS-007 — Work, Run, and Invocation Identity](../../TS-007-work-run-invocation-identity-model.md)
