# ADR-007 — Distinguish Work, Run, and Invocation Identity

**Status:** Implemented
**Scope:** Execution identity and provenance  
**Related:** RFC 1, RFC 2  
**MVP implementation:** Partial; cross-run continuation and Git provenance are deferred
