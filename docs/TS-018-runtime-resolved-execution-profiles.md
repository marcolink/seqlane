# TS-018 — Runtime-Resolved Agent Profiles

**Status:** Proposed
**Implements:** ADR-018
**Depends on:** ADR-004, ADR-005, ADR-008, ADR-016
**Scope:** MVP reusable agent profiles, runtime preflight, OpenCode
configuration, single-session transitions, and warning events
