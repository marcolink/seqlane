# ADR-012 — Provide a Fluent Seqlane Flow DSL

**Status:** Implemented
**Scope:** Public workflow authoring API and Plan construction
**Related:** ADR-001, ADR-003, ADR-006, ADR-008, Seqlane MVP
**Supersedes:** The static-DAG-only MVP constraint in ADR-003
...
Before implementation, create TS-012 and implementation stories that define:
