---
id: adr.model-selection-and-session-model-semantics
title: Model Selection and Session Model Semantics
status: accepted
owners:
  - core
created: 2026-09-03
...
- Reuse adr.session-checkpoint-reuse-and-branching session/checkpoint lifecycle and admission mechanisms.
- Where proposed adr.runtime-resolved-execution-profiles conflicts with direct model selection or session model
