...
from adr.executor-neutral-workflow-authoring. Their source must not select OpenCode, a provider, a model, a
...
- Update adr.repository-user-workflow-discovery-and-composition's implementation when built-in discovery is delivered; do not
