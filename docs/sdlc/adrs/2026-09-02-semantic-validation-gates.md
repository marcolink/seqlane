---
id: adr.semantic-validation-gates
title: Add Semantic Validation Gates to Seqlane
status: accepted
owners:
  - core
created: 2026-09-02
...
# Add Semantic Validation Gates to Seqlane
...
- Seqlane core and serialized Plans remain independent of Mastra and concrete
  executors.
- Runs remain autonomous and non-interactive under adr.autonomous-non-interactive-execution.
- V1 has no implicit automatic retry under adr.autonomous-non-interactive-execution.
...
- Human approval is outside this ADR and remains prohibited by adr.autonomous-non-interactive-execution.

## Required Follow-up

spec.semantic-validation-gates defines the public contracts, Plan representation, authoring helpers,
