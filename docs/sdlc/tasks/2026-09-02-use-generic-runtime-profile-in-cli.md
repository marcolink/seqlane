---
id: task.use-generic-runtime-profile-in-cli
title: Use a generic runtime profile in the CLI
status: completed
owners:
  - core
created: 2026-09-02
...
# Use a generic runtime profile in the CLI

> Migrated from implementation story `TS-008-03`.
