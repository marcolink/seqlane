---
id: task.define-typed-opencode-tasks
title: Define typed OpenCode tasks
status: completed
owners:
  - core
created: 2026-09-02
...
# Define typed OpenCode tasks

> Migrated from implementation story `TS-004-01`.
...
- [MVP — Strong Typing](../prd/2026-09-02-seqlane.md)
