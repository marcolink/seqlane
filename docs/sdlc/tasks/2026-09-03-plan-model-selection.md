---
id: task.plan-model-selection
title: Carry Session Model Selection Through Plan Contracts
status: completed
owners:
  - core
created: 2026-09-03
...
# Carry Session Model Selection Through Plan Contracts

> Migrated from implementation story `TS-022-01`.
