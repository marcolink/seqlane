---
id: task.emit-render-loop-events
title: Emit and Render Loop Lifecycle Events
status: completed
owners:
  - core
created: 2026-09-02
...
# Emit and Render Loop Lifecycle Events

> Migrated from implementation story `TS-012-04`.
