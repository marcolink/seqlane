---
id: task.bootstrap-builtins-package
title: Bootstrap the built-ins package and migrate the example
status: completed
owners:
  - core
created: 2026-09-02
...
# Bootstrap the built-ins package and migrate the example

> Migrated from implementation story `TS-009-00`.
