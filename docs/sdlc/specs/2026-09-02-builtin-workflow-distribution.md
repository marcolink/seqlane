---
id: spec.builtin-workflow-distribution
title: Built-in Workflow Distribution
status: superseded
owners:
  - core
created: 2026-09-02
...
spec.builtin-workflow-distribution does not implement:
...
spec.builtin-workflow-distribution is complete when:
...
- [adr.builtin-workflow-distribution](../adrs/2026-09-02-builtin-workflow-distribution.md)
