...
# Consumer-Agnostic Seqlane Execution Events

> Migrated from legacy technical specification `TS-016`.
...
spec.consumer-agnostic-seqlane-execution-events is complete when:
...
- [adr.consumer-agnostic-seqlane-execution-events — Consumer-Agnostic Seqlane Execution Events](../adrs/2026-09-02-consumer-agnostic-seqlane-execution-events.md)
- [adr.dedicated-runner-process — Dedicated Runner Process](../adrs/2026-09-02-dedicated-runner-process.md)
- [adr.dedicated-seqlane-output-package — Dedicated Seqlane Output Package](../adrs/2026-09-02-dedicated-seqlane-output-package.md)
