---
id: spec.semantic-validation-gates
title: Semantic Validation Gates and Evaluators
status: active
owners:
  - core
created: 2026-09-02
updated: 2026-09-03
upstream:
  - adr.semantic-validation-gates
supersedes: []
---

# Semantic Validation Gates and Evaluators

> Migrated from legacy technical specification `TS-015`.
...
spec.semantic-validation-gates is complete when:
...
spec.semantic-validation-gates does not implement:
...
- [adr.semantic-validation-gates — Semantic Validation Gates](../adrs/2026-09-02-semantic-validation-gates.md)
- [adr.seqlane-plan-ir-and-typed-dataflow — Seqlane Plan IR and Typed Dataflow](../adrs/2026-09-02-seqlane-plan-ir-and-typed-dataflow.md)
- [adr.autonomous-non-interactive-execution — Autonomous Non-Interactive Execution](../adrs/2026-09-02-autonomous-non-interactive-execution.md)
