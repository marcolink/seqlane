---
id: rfc.execution-observability-and-debugging
title: Seqlane Execution Observability and Debugging
status: proposed
owners:
  - core
created: 2026-09-02
...
# Seqlane Execution Observability and Debugging
...
Execution records use the rfc.seqlane-technical-architecture hierarchy:
...
rfc.execution-observability-and-debugging does not assume a human-interaction protocol.
...
Git commits may eventually be represented or correlated as repository artifacts using rfc.seqlane-technical-architecture provenance identities.
