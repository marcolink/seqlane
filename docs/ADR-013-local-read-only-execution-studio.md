# ADR-013 — Provide a Local Read-Only Execution Studio

**Status:** Implemented
**Scope:** Local execution inspection and runner-event delivery
**Related:** ADR-002, ADR-007, ADR-008, ADR-011, RFC-002
...
ADR-002 rejects a persistent Seqlane daemon. Studio must not create one as an
...
It also conflicts with ADR-002. This option is rejected for V1.
