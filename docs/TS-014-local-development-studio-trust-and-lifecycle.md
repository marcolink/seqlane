# TS-014 — Local Development Studio Trust and Lifecycle

**Status:** Implemented
**Scope:** Implementation of ADR-014
**Related:** ADR-002, ADR-013, ADR-014, TS-013
...
- Preserve TS-013 event, redaction, bounds, and SSE behavior.
- Do not edit ADR-013 or TS-013 historical text; this spec supersedes only
...
Update READMEs, examples, tests, and TS-013 cross-references. Do not preserve
...
5. Update READMEs and TS-013 cross-references.
6. Run service, CLI, browser, typecheck, lint, and format checks.

## 12. Source Decisions

- [ADR-014 — Simplify the Local Development Studio Trust and Lifecycle](ADR-014-local-development-studio-trust-and-lifecycle.md)
- [ADR-013 — Provide a Local Read-Only Execution Studio](ADR-013-local-read-only-execution-studio.md)
