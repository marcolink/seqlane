# TS-003 — Seqlane Plan IR and Typed Dataflow
...
The runner loader accepts an authored workflow definition in addition to the existing Plan and Plan-factory compatibility forms. It builds and validates the Plan in the child process, preserving TS-002's process boundary.
