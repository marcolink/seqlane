# ADR-019 — Use Effect as Seqlane's Private Runtime Engine

**Status:** Implemented
**Supersedes:** ADR-001 — Use Mastra as Seqlane's Internal Workflow Engine
**Scope:** Private in-process runtime scheduling, cancellation, and resource lifecycle
**Related:** ADR-002, ADR-003, ADR-005, ADR-008, ADR-015, ADR-016, ADR-018

## Context

ADR-001 selected Mastra as Seqlane's private workflow engine. The current
