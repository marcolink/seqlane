# ADR-008 — Keep Workflow Authoring and Plans Executor-Neutral

**Status:** Implemented
**Scope:** Public workflow authoring, Plan IR, and runtime boundaries
**Related:** ADR-001, ADR-003, ADR-004, ADR-005, ADR-006, RFC 1, Seqlane MVP
**Supersedes:** The workflow-authoring portion of ADR-004
...
Mastra remains a private runtime implementation under ADR-001. This ADR applies
...
- `docs/TS-003-seqlane-plan-ir-typed-dataflow.md` — remove executor identity
  from the public Plan contract and examples;
- `docs/TS-004-opencode-executor-integration.md` — retain the private adapter
  decision but remove OpenCode workflow-authoring exposure;
- `docs/MVP.md` — describe executor-neutral authoring and generic runtime
  configuration;
- `docs/ADR-006-repository-user-workflow-discovery-and-composition.md` — replace
