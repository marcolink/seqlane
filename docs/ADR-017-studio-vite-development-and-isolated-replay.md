# ADR-017 — Make Studio a Vite React App with Isolated Replay

**Status:** Proposed
**Scope:** Studio browser development, browser bundling, and local replay
**Related:** ADR-013, ADR-014, ADR-016, RFC-002
